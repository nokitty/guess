...
<asp:Content ID="Content1" ContentPlaceHolderID="body" runat="server">
    <div class="clearfix">
        <a href="/home/useradd" class="btn btn-primary pull-right"><span class="glyphicon glyphicon-plus"></span><span>新用户</span></a>
    ...
    <table class="table" style="margin-top: 10px;">
        ...
        <tr>
            ...
            <td>
                ...
                <a class="btn btn-default btn-xs" href="/home/userrecharge?id=<%=item.user.ID %>">充值</a>
